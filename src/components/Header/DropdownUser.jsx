...
const DropdownUser = () => {
  ...
  return (
    <>
      {isLoggingOut && (
        <div className="h-screen w-screen fixed grid place-content-center z-[100000000] bg-black/50 backdrop-blur-sm left-0 top-0">
          <div className="p-5 bg-white">
            <h2 className="text-2xl font-semibold">
              Are you sure you want to log out?
            </h2>
            <p>You will be logged out of your account.</p>
            <div className="flex gap-10 justify-center pt-10 font-semibold text-black">
              <button onClick={handleLogout} className=" p-3 bg-red-400 ">
                Log Out
              </button>
              <button
      ...
      <div className="relative">
        ...
        <div
          ...
          <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark">
            <span className=" lg:hidden block text-sm font-medium text-black dark:text-white text-center">
              {user.firstName} {user.lastName}
