    ...
    return (
      <>
        ...
        >
          ...
          <DialogContent className="max-w-[40em] lg:max-w-[60em] rounded-sm border border-stroke bg-white p-4 !text-black shadow-default dark:border-strokedark dark:bg-boxdark dark:!text-white">
            <DialogHeader>
