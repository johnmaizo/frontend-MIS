...
const ButtonActionSubject = ({ action, subjectId, onSuccess }) => {
  ...
  const handleAction = async () => {
    ...
    try {
      ...
      await toast.promise(
        axios.put(`/subjects/${subjectId}`, { isDeleted }),
        {
          loading: isDeleted
            ? "Deleting subject..."
            : "Reactivating subject...",
          success: isDeleted
            ? "Subject deleted successfully!"
            : "Subject reactivated successfully!",
          error: isDeleted
            ? "Failed to delete subject."
            : "Failed to reactivate subject.",
        },
        {
      ...
      if (err.response && err.response.data && err.response.data.message) {
        ...
        toast.error(`Failed to update subject status: ${err}`, {
          position: "bottom-right",
          duration: 4500,
        });
      }
...
export default ButtonActionSubject;
