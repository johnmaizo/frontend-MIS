      ...
      <div>
        ...
        <ul className="mb-6 flex flex-col gap-1.5">
          ...
          <li>
            <NavLink
              to="/enrollments"
              className={`group relative flex items-start gap-2.5 rounded-sm px-4 py-2 font-medium duration-300 ease-in-out hover:bg-gray dark:text-bodydark1 dark:hover:bg-meta-4 ${
                    ...
                    <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                      ...
                      <li>
                        <NavLink
                          ...
                          className={({ isActive }) =>
                            `group relative flex items-center gap-2.5 rounded-md px-4 font-medium underline-offset-4 duration-300 ease-in-out hover:underline dark:text-bodydark1 ${
                              (pathname === "/teachers/teacher-list" ||
                    ...
                    <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                      <li>
                        <NavLink
                          to="/ui/alerts"
                          className={({ isActive }) =>
                            "group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:underline " +
