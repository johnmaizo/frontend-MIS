...
const AdminSidebar = ({sidebarExpanded, setSidebarExpanded}) => {
  ...
  return (
    <>
      {/* <!-- Menu Group --> */}
      <div>
        <h3 className="mb-4 ml-4 text-sm font-semibold text-bodydark2">ADMIN MENU</h3>
        ...
        <ul className="mb-6 flex flex-col gap-1.5">
          ...
          <li>
            <NavLink
              ...
              className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                pathname.includes("/admin/calendar") && "bg-graydark dark:bg-meta-4"
              }`}>
              <svg
                className="fill-current"
                width="18"
          ...
          <li>
            <NavLink
              to="/admin/profile"
              className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                pathname.includes("/admin/profile") && "bg-graydark dark:bg-meta-4"
              }`}>
              <svg
                className="fill-current"
                width="18"
