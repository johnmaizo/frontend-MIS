...
const StudentSidebar = () => {
  ...
  return (
    <>
      {/* <!-- Menu Group --> */}
      <div>
        <h3 className="mb-4 ml-4 text-sm font-semibold uppercase dark:text-bodydark1">
          Student Menu
        </h3>
      ...
      <div>
        ...
        <ul className="mb-6 flex flex-col gap-1.5">
          <li className="dark:text-bodydark1">Lorem, ipsum dolor.</li>
          <li className="dark:text-bodydark1">Vel, facere aliquid.</li>
          <li className="dark:text-bodydark1">Totam, ducimus quisquam?</li>
